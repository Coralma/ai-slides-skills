...
- **Logo watermark with company name** at top-left of every slide — **MUST embed as base64 data URI** (do NOT use relative file paths). Use a flex container wrapping the logo image and company name text. Use this exact HTML with the complete base64 data below:
  ```html
